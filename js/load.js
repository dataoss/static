$(function(){ 		
        ...
        '.teles i:after {content:"";position:absolute;bottom:4px;left: 50%;width:33px;height: 16px;background-repeat: no-repeat; -webkit-background-size: 100% 100%;background-size: 100% 100%;background-image:url(/static/images/arrow.png);-webkit-animation: arrow 400ms ease-out alternate infinite;animation: arrow 400ms ease-out alternate infinite;margin-left: -6px;}'+	   
